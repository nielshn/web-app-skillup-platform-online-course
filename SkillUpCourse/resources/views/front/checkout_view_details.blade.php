                ...
                <div class="flex flex-row gap-x-10">
                    ...
                    <div class="flex flex-col gap-y-10">
                        ...
                        @if ($transactions->is_paid)
                            <span
                                class="w-fit text-sm font-bold py-2 px-3 rounded-full bg-green-500 text-white">ACTIVE</span>
                        @else
                            <span
                                class="w-fit text-sm font-bold py-2 px-3 rounded-full bg-orange-500 text-white">PENDING</span>
                        @endif
                        <div>
                    ...
                    <div>
                        <img src="{{ Storage::url($transactions->proof) }}" alt="">
                    </div>
                </div>
                <hr class="my-5">
            </div>
