    ...
    <div id="checkout-section"
        ...
        <div class="flex gap-10 px-[100px] relative z-10">
                ...
                <div class="flex items-center justify-between w-full">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex flex-col gap-[2px]">
                            ...
                            <p class="text-sm text-[#6D7786]">1 Year access</p>
                        </div>
                    </div>
            ...
            <form action="{{ route('front.checkout.store') }}" method="POST"
                class="w-full flex flex-col bg-white rounded-2xl p-5 gap-5" enctype="multipart/form-data">
                @csrf
                ...
                <div class="flex flex-col gap-5">
                    <div class="flex items-center justify-between">
                        ...
                        <p class="font-semibold">Daniel Siahaan</p>
                        <input type="hidden" name="bankName" value="Daniel Siahaan">
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex gap-3">
                            <div class="w-6 h-6 flex shrink-0">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <p class="font-semibold">SkillUp Online Course</p>
                        <input type="hidden" name="accountName" value="SkillUp Online Course">
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex gap-3">
                            <div class="w-6 h-6 flex shrink-0">
